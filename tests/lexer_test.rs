...
fn TestNextToken() {
    ...
    let tests = vec![
        TokenTest {
            ...
            expectedLiteral: String::from("let"),
        },
        TokenTest {
            expectedType: token::IDENT,
            expectedLiteral: String::from("five"),
        },
        TokenTest {
            expectedType: token::ASSIGN,
            expectedLiteral: String::from("="),
        ...
        TokenTest {
            expectedType: token::IDENT,
            expectedLiteral: String::from("ten"),
        },
        TokenTest {
            expectedType: token::ASSIGN,
            expectedLiteral: String::from("="),
        ...
        TokenTest {
            expectedType: token::INT,
            expectedLiteral: String::from("10"),
        },
        TokenTest {
            expectedType: token::SEMICOLON,
            expectedLiteral: String::from(";"),
        ...
        TokenTest {
            expectedType: token::IDENT,
            expectedLiteral: String::from("add"),
        },
        TokenTest {
            expectedType: token::ASSIGN,
            expectedLiteral: String::from("="),
        ...
        TokenTest {
            ...
            expectedLiteral: String::from("fn"),
        },
        TokenTest {
            expectedType: token::LPAREN,
            expectedLiteral: String::from("("),
        ...
        TokenTest {
            expectedType: token::IDENT,
            expectedLiteral: String::from("result"),
        },
        TokenTest {
            expectedType: token::ASSIGN,
            expectedLiteral: String::from("="),
        ...
        TokenTest {
            ...
            expectedLiteral: String::from("if"),
        },
        TokenTest {
            expectedType: token::LPAREN,
            expectedLiteral: String::from("("),
        ...
        TokenTest {
            ...
            expectedLiteral: String::from("return"),
        },
        TokenTest {
            expectedType: token::TRUE,
            expectedLiteral: String::from("true"),
        },
        TokenTest {
            expectedType: token::SEMICOLON,
            expectedLiteral: String::from(";"),
        ...
        TokenTest {
            ...
            expectedLiteral: String::from("else"),
        },
        TokenTest {
            expectedType: token::LBRACE,
            expectedLiteral: String::from("{"),
        ...
        TokenTest {
            ...
            expectedLiteral: String::from("false"),
        },
        TokenTest {
            expectedType: token::SEMICOLON,
            expectedLiteral: String::from(";"),
